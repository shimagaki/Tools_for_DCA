...
function gradient_ascent(q::Int64, L::Int64, lambda_h::Float64, lambda_xi::Float64, reg_h::Float64, reg_xi::Float64,  f1_data::Array{Float64,1},  f1_model::Array{Float64,1}, psi_data::Array{Float64,2},  psi_model::Array{Float64,2}, xi::Array{Float64, 2}, h::Array{Float64, 1})
	...
	return (xi,h,sqrt(sum(dh.^2)), sqrt(sum(dxi.^2))) 
end
...
function Test_Autocorrelations_rbm_i(q::Int64, L::Int64, P::Int64, n_max::Int64, T_eq::Int64, xi::Array{Float64, 2}, h::Array{Float64, 1})
	av_overlap = 0.0
    (J_HP,h_HP) = convert_xi2J_h(xi, q, L, P)
    h_tot = h_HP + h
    #T_eq_overlap = T_eq; # this is ad hoc
    ...
    p1 = Plots.plot!(av_overlap*ones(T_eq), label="<q1q2>", color="red")
